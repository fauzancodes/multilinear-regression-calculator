...
#loading input file
print("\n","Data Requirements:", "\n",
    "1. Your data should have at least 6 column with the same length", "\n",
    "2. Four column for X-axis, one column for Y-axis, one column for color bar","\n",
...
column_x4 = input("The data for the X4-axis are in column (ex: 1 or 2 or etc.): ")
...
x4 = np.array(fileInput[:, (int(column_x4) - 1)])
